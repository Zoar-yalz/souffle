...
void Engine::createRelation(const ram::Relation& id, const std::size_t idx) {
    ...
    } else if (id.getRepresentation() == RelationRepresentation::POREL) {
        res = createPorelRelation(id, isa.getIndexSelection(id.getName()));
    } else if (id.getRepresentation() == RelationRepresentation::TCREL) {
        res = createTcrelRelation(id, isa.getIndexSelection(id.getName()));
